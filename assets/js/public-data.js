...
function renderProjectDetailsNotFound() {
    setPublicText("detailsCategory", "Project Details");
    setPublicText("detailsTitle", "Project Not Found");
    setPublicText("detailsShortDescription", "The requested project could not be found or is not published yet.");
    setPublicText("detailsOverviewTitle", "Project Not Found");
    setPublicText("detailsOverviewText", "Please go back to the projects page and choose a published project.");
    setPublicText("detailsClient", "—");
    setPublicText("detailsDuration", "—");
    setPublicText("detailsMainResult", "—");
    setPublicText("detailsPlatform", "—");
    setPublicText("detailsProblem", "No project data available.");

    const strategyList = document.getElementById("detailsStrategyList");
    if (strategyList) renderEmptyBox(strategyList, "No strategy data available.");

    const toolsList = document.getElementById("detailsToolsList");
    if (toolsList) renderEmptyBox(toolsList, "No tools data available.");

    const resultsList = document.getElementById("detailsResultsList");
    if (resultsList) renderEmptyBox(resultsList, "No result data available.");
}
